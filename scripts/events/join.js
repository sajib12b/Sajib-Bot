...
.then(response => {
  ...
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    return api.sendMessage("চলে এসেছি আমি পিচ্চি সজিব তোমাদের মাঝে🤭!", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME}
<------------------------------>  
𝗛𝗟𝗔𝗦 (সূরা ইখলাস) 🌙                        ║
║                                                      ║
║ ﷽                                                   ║
...
╠══════════════════════════════════════════════════════╣
║ 🔗 𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞 :                                        ║
║ 🌐 https://www.facebook.com/sajib.miah946252          ║
╠══════════════════════════════════════════════════════╣
║ 📞 𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣 : wa.me/+1 416256-0000                    ║
╠══════════════════════════════════════════════════════╣
║ ✉️ 𝗘𝗠𝗔𝗜𝗟 :                                            ║
║      sajibboss@rapt.be                       ║
╠══════════════════════════════════════════════════════╣
